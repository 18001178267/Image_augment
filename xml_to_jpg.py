...
if __name__ == '__main__':
	# 使用英文路径，中文路径读不进来
    imgs_path = r'C:\\Users\\YFZX\\Desktop\\orginal\\model\\original_test_img\\'  #图片路径
    xmls_path = r'C:\\Users\\YFZX\\Desktop\\orginal\\model\\original_test_xml\\' #xml路径
    retangele_img_path =r'C:\\Users\\YFZX\\Desktop\\orginal\\model\\vertify\\' #保存画框后图片的路径
